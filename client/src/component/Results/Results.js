        ...
        <div>
          {!this.state.isElStarted && !this.state.isElEnded ? (
            ...
            <div className="container-item attention">
              <center>
                <h3>Pemilihan sedang berlangsung!!.</h3>
                <p>Hasil akan ditampilkan ketika pemilihan telah berakhir</p>
                <p>Silahkan Pilih Kandidat anda {"(Jika Belum Memilih)"}.</p>
                <br />
                <Link
                  to="/Voting"
    ...
    return (
      <div className="container-winner">
        ...
        <div className="winner-votes">
          <div className="votes-tag">Total Pemilih: </div>
  ...
  return (
    <>
      ...
      <div className="container-main" style={{ borderTop: "1px solid" }}>
        <h2>Hasil</h2>
        <small>Total Kandidat: {candidates.length}</small>
        {candidates.length < 1 ? (
          <div className="container-item attention">
            <center>Tidak ada Kandidat.</center>
          </div>
        ) : (
          <>
